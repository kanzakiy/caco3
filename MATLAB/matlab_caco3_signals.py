...
#    Workdir = 'C:/Users/YK/Desktop/Sed_res/'
    Workdir = "/home/domhu/Documents/GitHub/caco3/MATLAB/2406_labs/"
...
#    Workdir = "./"
    ...
    rectime = np.loadtxt(Workdir+'matlab_rectime.txt')
#    frac = np.loadtxt(Workdir+'frac.txt')
    sig = np.loadtxt(Workdir+'matlab_sigmly.txt')
    bound = np.loadtxt(Workdir+'matlab_bound.txt')
...
def main():
    ...
    outname = '50kyr-5km-allsb_chk_labs_matlab_2406'
